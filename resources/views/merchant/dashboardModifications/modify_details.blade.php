...
<body>
    <div class="page">
        ...
        <div class="page-header">
            <span class="page-label">Merchant Settings</span>
        ...
        <div class="change form-card" style="display: none;">
            <form action="{{ route('merchant.profile.update') }}" method="POST">
                ...
                <p class="form-desc">Update your display name or change your password below.</p>
                <div class="field">
                    <label for="merchant_name">Full Name</label>
                    <input type="text" id="merchant_name" name="merchant_name" placeholder="Enter your full name">
                </div>
                <div class="field">
                    <label for="merchant_password">New Password</label>
                    <input type="password" id="merchant_password" name="merchant_password" placeholder="Enter new password">
                </div>
        ...
        <div class="delete form-card" style="display: none;">
            <form action="{{ route('merchant.account.delete') }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="field">
                    ...
                    <input type="password" id="delete_password" name="merchant_password" placeholder="Enter your password to confirm">
                </div>
